...
.product-form-wrapper .current-image-section {
    margin-bottom: 20px;
    padding: 15px;
    background: #f8fafc;
    border-radius: 10px;
...
.product-form-wrapper .current-image-section h4 {
    color: #334155;
    font-size: 14px;
    font-weight: 600;
    margin: 0 0 10px 0;
...
.product-form-wrapper .current-image-container {
    text-align: center;
}

.product-form-wrapper .current-image {
    max-width: 200px;
    max-height: 200px;
    border-radius: 10px;
    border: 2px solid #e2e8f0;
...
<div class="product-form-wrapper">
    <div class="modern-form-container">
        ...
        <form action="functions/products/update.php?id=<?=$product['id']?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modern-form-group">
                    ...
                    <div class="modern-input-wrapper">
                        ...
                        <input type="number" 
                               ...
                               id="productSale" 
                               name="sale" 
                               placeholder="<?php echo getPlaceholder('sale', '0.00'); ?>" 
                               step="0.01" 
                               min="0" 
                               value="<?=$product['sale']; ?>">
                    </div>
            ...
            <div class="modern-form-group">
                ...
                <div class="current-image-section">
                    <div class="current-image-container">
                        <img src="images/<?=$product['img']; ?>" alt="Current Product" class="current-image">
                    </div>
                </div>
                <div class="info-text">
                    <i class="fas fa-info-circle"></i>
                    <span>Upload a new image to replace the current one, or leave empty to keep it</span>
                </div>
            </div>
            <?php endif; ?>
